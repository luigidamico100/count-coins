...
def read_image(image_path, as_gray=False, as_PIL=False, plot_image=False):
...
def save_deeplearning_experiment(model, df_training_info, fig_training, models_path, experiment_name):
